<template>
  <div id="root" class="w-full">
    ...
    <p class="speech">A flock of executive laughter floats by.</p>
    ...
    <p>
      ...
      <span class="magenta">customer</span>s at the bar are men who have come here alone, and everyone is on their phone arranging causal <span class="magenta">sex</span> or buying <span class="magenta">sneakers</span> or trying to recruit a <span class="magenta">project manager</span>. I am waiting on emails from Github or my mom. I wonder if my anxiety disorder is related to how she spent the pregnancy watching the first Gulf War on CNN. Blink-182 comes on Spotify and I finally do start to cry, but the battery dies before the first chorus and everybody starts cracking jokes before putting on more trap.
    </p>
    ...
    <p>
      I make interactive billboards to score enough
      <span class="magenta">$$$</span> to get fucked up in a room full of strangers under an endlessly repeating sports event. I have air conditioning and locks on my door and YouTube videos and vegan canned soup. The camps along the tracks catch fire once or twice a month. I can see the gas station from my bed, lift my head up and see tiny shadow people buying cigarettes and gas and whatever.
    </p>
    ...
    <p>
      Google this:
      <a
        href="https://www.google.com/search?q=anal+fistula&rlz=1C5CHFA_enUS847US847&oq=anal+fistula&aqs=chrome..69i57j0l7.3206j0j4&sourceid=chrome&ie=UTF-8"
        target="_blank"
      >Anal fistula.</a>
    </p>
    <p>
